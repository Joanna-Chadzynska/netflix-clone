...
describe('<Card/>', () => {
	let getByText, queryByText, container, getByTestId, getByAltText;
	beforeEach(() => {
	...
	it('renders the basic <Card /> with populated data', () => {
	...
	it('renders the basic <Card /> and toggles the card feature', () => {
